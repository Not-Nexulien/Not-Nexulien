...
import { CloudTab, NotificationsTab, PatchHelperTab, PluginsTab, ThemesTab, UpdaterTab, VencordTab } from "@components/settings/tabs";
...
export default definePlugin({
    ...
    getInfoRows() {
        ...
        const rows = [`Not-Nexulien ${gitHash}${additionalInfo}`];
