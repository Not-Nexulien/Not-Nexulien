...
export function NotificationSettings() {
    ...
    return (
        <div style={{ padding: "1em 0" }}>
            ...
            <Forms.FormTitle tag="h5" className={classes(Margins.top16, Margins.bottom8)}>Notification Position</Forms.FormTitle>
            <Select
            ...
            <Forms.FormTitle tag="h5" className={classes(Margins.top16, Margins.bottom8)}>Notification Timeout</Forms.FormTitle>
            ...
            <Forms.FormTitle tag="h5" className={classes(Margins.top16, Margins.bottom8)}>Notification Log Limit</Forms.FormTitle>
